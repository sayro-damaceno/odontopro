...
export function Hero() {
  return (
    <section className="bg-white">
      <div className="container mx-auto px-4 pt-20 pb-4 lg:pb-0 sm:px-6 lg:px-8">
        <main className="flex items-center justify-center">
          <article className="flex-2 max-w-3xl space-y-8 flex flex-col justify-center">
            ...
            <Button className="bg-emerald-500 hover:bg-emerald-600 w-fit px-6 font-bold">
          ...
          <div className="hidden lg:block">
            <Image
              src={doctorImage}
              alt="Foto de um profissional da saúde"
              width={340}
              height={400}
